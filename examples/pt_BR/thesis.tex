%% -*- coding: utf-8; -*-
\documentclass[dsc,brazilian]{ThesisPUC} % Aqui é possível mudar o padrão do documento dsc(Doutor em Ciências), msc(Mestre) or phd(Doutor) dependendo do seu curso
