...
{
  \noindent
  To Conselho Nacional de Desenvolvimento Científico e Tecnológico (CNPq) for partially financing this research under grant XXXXXX/YYYY-X. This study was financed in part by the Coordenação de Aperfeiçoamento de Pessoal de Nível Superior - Brasil (CAPES) - Finance Code 001 \\
}
...
\abrevlist{\include{abrevs}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}

\input{../common/ThesisText}
